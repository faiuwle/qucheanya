...
\entry{Sotsai}{Noun}{That thing. \textbf{so-} + \textbf{tsai}. Can be reduplicated to \textbf{sosot\nobreak sai}.}
...
\entry{Ny\"area}{Verb}{Need; a requirement enforced by onesself. Takes either a noun or a clause headed by \textbf{qqhoasui} as a direct object.}
...
\entry{Nyufeisy\"a}{Noun}{The name of the smaller moon.  \textbf{nyu-} + \textbf{feisy\"a}, literally the ``little sister''.}

\entry{Nyufeisy\"alye Ciria}{Noun}{The extra middle day of the month in the third, sixth, and ninth months that is used for celebrating the smaller moon.}
...
\entry{Rapui}{Verb}{Ought, should, must; a requirement enforced by a third party. Takes a clause headed by \textbf{qqhoa} as its subject.}
...
\glb rain$_i$ -\scap{FUT} -\scap{TOP} \scap{PRS} \scapp{1S}{NOM} \scapp{RFL}{NOM}$_i$ near- time stop \scap{CMP} -\scap{ACC} hope //
...
\glb \scap{FUT} \scapp{2S}{TOP} more neat write \scapp{CMP}{NOM} ought //
