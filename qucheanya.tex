...
\glb store -\scap{PST} -\scap{TOP} \scapp{1S}{NOM} \scapp{RFL}{LOC} to yesterday -\scap{LOC} go \scap{PRF} //
...
\glb store -\scap{PRS} -\scap{TOP} \scapp{1S}{NOM} \scapp{RFL}{LOC} to near- time go //
...
\glb store -\scap{FUT} -\scap{TOP} \scapp{1S}{NOM} \scapp{RFL}{LOC} to tomorrow -\scap{LOC} go \scap{PRF} //
...
\glb book -\scap{FUTD} -\scap{TOP} \scapp{1S}{NOM} \scapp{RFL}{ACC} person- Sapfita -title Yesora -\scap{PST} -\scap{DAT} past -\scap{LOC} give \scap{PRF} //
...
\glb \scap{PST} \scapp{1S}{TOP} \scapp{RFL}{NOM} table -\scap{LOC} eat //
...
\glb person- Sapfita -\scap{PRS} -\scap{TOP} \scapp{1S}{NOM} \scapp{RFL}{NOM} be //
...
\glb \scap{PRS} \scapp{1S}{TOP} \scapp{RFL}{GENI} sister.\scap{NOM} Vrel -\scap{LOC} be \scap{HAB} //
...
\glb \scap{PRS} \scapp{1P}{TOP} [[\scappp{RFL}{NOM}{PL} more slow eat] \scapp{CMP}{NOM}] ought //
...
\glb \scap{FUT} \scapp{2S}{TOP} \scap{PRS} \scapp{1S}{NOM} [[\scapp{RFL}{NOM} person- Sapfita.\scap{NOM} become] \scap{CMP} -\scap{ACC}] hope //
...
\glb far- time -\scap{N} -\scap{PST} -\scap{TOP} wild animal.\scapp{NOM}{PL} \scapp{RFL}{LOC} near- place exist \scap{HAB} //
...
\glb far- time -\scap{N} -\scap{PST} -\scap{TOP} near- place wild animal.\scapp{NOM}{PL} \scapp{RFL}{LOC} exist \scap{HAB} //
...
\glb baby -\scap{PST} -\scap{TOP} \scapp{RFL}{GENA} ball.\scap{NOM} away- roll \scap{PRF} \scap{FTRL} //
\glft ``The baby's ball has rolled away.'' //
\endgl
\xe
